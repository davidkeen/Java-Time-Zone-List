...
public class TimeZoneList {
    ...
    private TimeZoneList() {
        Set<String> availableIdsSet = new HashSet<>(Arrays.asList(TimeZone.getAvailableIDs()));
        ...
        Comparator<TimeZoneWithDisplayNames> offsetComparator = (a, b) -> {
        ...
        timeZones.sort(offsetComparator);
    }
